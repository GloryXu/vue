<template>
  <div>
    ...
    <el-button @click="load"
               type="primary">加载</el-button>

    <el-input type="textarea"
              v-model="getMySavedModel"
              rows="10"
              style="width:100%;height:300px"></el-input>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        myDiagram:{},
        myPalette:{},
        mySavedModel:{ "class": "go.GraphLinksModel",
    ...
    computed:{
      getMySavedModel() {
        return JSON.stringify(this.mySavedModel, null, 2);
      }
    }
  }
</script>
